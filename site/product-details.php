                     ...
                     <nav>
                        <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                           ...
                           <?php foreach ($images as $img): ?>
                              <button class="nav-link <?= $index_img == 0 ? 'active' : '' ?>" id="nav-1-tab"
                                 data-bs-toggle="tab" data-bs-target="#nav-<?= $img['img_id'] ?>" type="button" role="tab"
                                 aria-controls="nav-1" aria-selected="<?= $index_img == 0 ? 'true' : 'false' ?>">
                     ...
                     <div class="tab-content m-img" style="width: 100%;" id="productDetailsNavContent">
                        ...
                        <?php foreach ($images as $img): ?>
                           <div class="tab-pane fade <?= $index == 0 ? 'active show' : '' ?>"
                              id="nav-<?= $img['img_id'] ?>" role="tabpanel" aria-labelledby="nav-1-tab" tabindex="0">
                              <div class="tp-product-details-nav-main-thumb">
                                 <img width="100%" src="../content/img/products/<?= $product_id ?>/<?= $img['img_name'] ?>"
                                    alt="">
                              </div>
                           </div>
                           <?php $index = +1 ?>
                        ...
                        <div class="tp-product-details-action-wrapper">
                           ...
                           <div class="tp-product-details-action-item-wrapper d-flex align-items-center">
                              ...
                              <div class="tp-product-details-add-to-cart mb-15 w-100">
                                 <button class="tp-product-details-add-to-cart-btn w-100" onclick="validateForm(this)"
                                    name="add-cart" type="button">Add To Cart</button>
                           ...
                           <button type="button" class="tp-product-details-buy-now-btn w-100" name="buy-now" onclick="validateForm(this); toCart()">Buy Now</button>
                        </div>
                     </form>
                     <!-- end form variations -->
                                       ...
                                       <div class="row">
                                          <div class="col-lg-6">
                                             <div class="tp-product-details-desc-content pt-25">
                                                ...
                                                <p>With a slim design, a vibrant entertainment system, and <br>
                                                   ...
                                                   <br> and easily share your favorite moments. Learn, explore, connect
                                                   <br> and be inspired.
                                                </p>
                                             </div>
                                             <div class="tp-product-details-desc-content">
                                                <h3 class="tp-product-details-desc-title">Draw inspiration with S Pen
                                                </h3>
                                                <p>S Pen is a bundle of writing instruments in one. Its natural grip,
                                                   <br> low latency and impressive pressure sensitivity will make it
                                                   your go-to for everything from drawing to editing documents. And S
                                                   Pen won't get misplaced thanks.
                                                </p>
                                             </div>
                                          </div>
                                          <div class="col-lg-6">
                                             <div class="tp-product-details-desc-thumb">
                                                <img src="assets/img/product/details/desc/product-details-desc-1.jpg"
                                                   alt="">
                                             </div>
                                          </div>
                                       </div>
                                       ...
                                       <div class="row">
                                          ...
                                          <div class="col-lg-5 order-first order-lg-last">
                                             <div class="tp-product-details-desc-content des-content-2 pl-40">
                                                <h3 class="tp-product-details-desc-title">Carry with <br> Confidence and
                                                   style</h3>
                                                <p>Wrap your tablet in a sleek case that's as stylish as it is
                           ...
                           <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                              ...
                              <div
                                 ...
                                 <div class="tp-product-action-item-3 d-flex flex-column">
                                    ...
                                    <button type="button" class="tp-product-action-btn-3 tp-product-quick-view-btn"
