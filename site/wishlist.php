                  ...
                  <div class="col-xl-12">
                     <div class="tp-cart-list mb-45 mr-30">
                        ...
                        <table class="table">
                           ...
                           <tbody>
                              <!-- foreach -->
                              <?php foreach ($_SESSION['wishlist'] as $wish): ?>    
                              <tr>
                                 <?php $product = select_product_by_id($wish);
                                       $img = select_one_img_by_product_id($wish);
                                 ?>
                                 <!-- img -->
                                 <td class="tp-cart-img"><a href="index.php?act=product-details?product_id=<?= $wish?>"> <img src="../content/img/products/<?= $wish?>/<?= $img['img_name']?>" alt=""></a></td>
                                 <!-- title -->
                                 ...
                                 <td class="tp-cart-action">
                                    <button class="tp-cart-action-btn">
                                       ...
                                       <a href="delete-from-wishlist.php?product_id=<?= $wish?>"><span>Remove</span></a>
                                    </button>
                                 </td>
                              </tr> 
                              <?php endforeach ?>
