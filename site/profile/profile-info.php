            ...
            <form action="" method="post">
                <div class="row">
                    ...
                    <div class="col-xxl-6 col-md-6">
                        <div class="profile__input-box">
                            <div class="profile__input">
                                <input type="text" placeholder="Enter your number" value="<?= $user['phone_number'] ?? ''?>">
                                <span>
                                    <svg width="15" height="18" viewBox="0 0 15 18" fill="none"
                                        ...
                                        <path
                                            ...
                                            stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path opacity="0.4" d="M9.08026 3.80054H5.85156" stroke="currentColor"
                    ...
                    <div class="col-xxl-6 col-md-6">
                        <div class="profile__input-box">
                            <div class="profile__input">
                                <select name="sex">
                                    <option value="nam" <?php if($user['sex']  == "nam") {echo 'selected';}else{echo '';}?>>Male</option>
                                    <option value="nữ" <?php if($user['sex']  == "nữ6") {echo 'selected';}else{echo '';}?>>Female</option>
                    ...
                    <div class="col-xxl-12">
                        <div class="profile__input-box">
                            <div class="profile__input">
                                <input type="text" placeholder="Enter your address" value="<?= $user['address'] ?? ''?>">
                                <span>
