...
if (isset($_POST['register'])) {
  ...
  $user_exist = select_user_by_email($email);

  if(count($user_exist) >=1 ){
    echo "<script>alert('email đã tồn tại')</script>";
    $message['user_exist'] = "1";
  }
  ...
  if (!isset($message)) {
    ...
    if (!isset($_POST['remeber'])) {
      $message['remeber'] = "Bạn chưa chấp nhận điều khoản";
    } else {
      $hash_password = password_hash($password, PASSWORD_DEFAULT);
      $created_on = date("Y-m-d");
      $res = register($email, $hash_password, $name, $created_on);
      setcookie("register-success", "Đã đăng ký tài khoản thành công", time() + 30);
          ...
          <div class="tp-login-wrapper">
            <div class="tp-login-top text-center mb-30">
              ...
              <p>
                ...
                <span><a href="index.php?act=login">Sign In</a></span>
              </p>
            </div>
              ...
              <form action="" method="post">
                ...
                <div class="tp-login-input-wrapper">
                  <div class="tp-login-input-box">
                    <div class="tp-login-input">
                      <input id="name" type="text" placeholder="Shahnewaz Sakil" name="name" />
                    </div>
                  ...
                  <div class="tp-login-input-box">
                    <div class="tp-login-input">
                      <input id="email" type="email" placeholder="shofy@mail.com" name="email" />
                    </div>
                    <div class="tp-login-input-title">
                  ...
                  <div class="tp-login-input-box">
                    <div class="tp-login-input">
                      <input id="tp_password" type="password" placeholder="Min. 6 character" name="password" />
                    </div>
                  ...
                  <div class="tp-login-input-box">
                    <div class="tp-login-input">
                      <input id="tp_password" type="password" placeholder="Min. 6 character" name="check_password" />
                    </div>
                    <div class="tp-login-input-eye" id="password-show-toggle">
                      <span id="open-eye" class="open-eye">
                        <svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="tp-login-input-title">
                      <label for="tp_password">Check password</label>
                    </div>
                ...
                <div class="tp-login-suggetions d-sm-flex align-items-center justify-content-between mb-20">
                  <div class="tp-login-remeber">
                    <input id="remeber" type="checkbox" name="remeber" />
                    <label for="remeber">I accept the terms of the Service &
                      <a href="#">Privacy Policy</a>.</label>
                  </div>
                </div>
                <div class="<?= isset($message['remeber']) ? 'alert' : '' ?> alert-danger">
                  <?= $message['remeber'] ?? '' ?>
                </div>
                <div class="tp-login-bottom">
                  <button class="tp-login-btn w-100" type="submit" name="register">Sign Up</button>
                </div>
              </form>
            </div>
